...
{/* FIX: Add an `Array.isArray` check to ensure `vet.services` is an array before attempting to map over it. This prevents runtime errors if the value is not an array. */}
