...
{/* FIX: Check if vet.services is an array before calling .length or .map, as Supabase may return a single object instead of an array for a to-many relationship with only one result. */}
